...
const NAMESPACE = 'futureui';
const BUILD = /* futureui */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, devTools: false, disconnectedCallback: false, element: false, event: true, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: false, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: false, propString: true, reflect: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: true, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: false };
...
const createElm = (e, t, o, n) => {
 ...
 var n, s;
 const l = e.$hostElement$, r = e.$vnode$ || newVNode(null, null), i = isHost(t) ? t : h(null, null, t);
 if (hostTagName = l.tagName, BUILD.isDev  ) ;
 if (o && i.$attrs$) for (const e of Object.keys(i.$attrs$)) l.hasAttribute(e) && ![ "key", "ref", "style", "class" ].includes(e) && (i.$attrs$[e] = l[e]);
...
const ftContainerCss = "/*!@*,\n::before,\n::after*/*.sc-ft-container,.sc-ft-container::before,.sc-ft-container::after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}/*!@::before,\n::after*/.sc-ft-container::before,.sc-ft-container::after{--tw-content:''}/*!@html*/html.sc-ft-container{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;-o-tab-size:4;tab-size:4;font-family:ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";font-feature-settings:normal;font-variation-settings:normal}/*!@body*/body.sc-ft-container{margin:0;line-height:inherit}/*!@hr*/hr.sc-ft-container{height:0;color:inherit;border-top-width:1px}/*!@abbr:where([title])*/abbr.sc-ft-container:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}/*!@h1,\nh2,\nh3,\nh4,\nh5,\nh6*/h1.sc-ft-container,h2.sc-ft-container,h3.sc-ft-container,h4.sc-ft-container,h5.sc-ft-container,h6.sc-ft-container{font-size:inherit;font-weight:inherit}/*!@a*/a.sc-ft-container{color:inherit;text-decoration:inherit}/*!@b,\nstrong*/b.sc-ft-container,strong.sc-ft-container{font-weight:bolder}/*!@code,\nkbd,\nsamp,\npre*/code.sc-ft-container,kbd.sc-ft-container,samp.sc-ft-container,pre.sc-ft-container{font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace;font-size:1em}/*!@small*/small.sc-ft-container{font-size:80%}/*!@sub,\nsup*/sub.sc-ft-container,sup.sc-ft-container{font-size:75%;line-height:0;position:relative;vertical-align:baseline}/*!@sub*/sub.sc-ft-container{bottom:-0.25em}/*!@sup*/sup.sc-ft-container{top:-0.5em}/*!@table*/table.sc-ft-container{text-indent:0;border-color:inherit;border-collapse:collapse}/*!@button,\ninput,\noptgroup,\nselect,\ntextarea*/button.sc-ft-container,input.sc-ft-container,optgroup.sc-ft-container,select.sc-ft-container,textarea.sc-ft-container{font-family:inherit;font-feature-settings:inherit;font-variation-settings:inherit;font-size:100%;font-weight:inherit;line-height:inherit;color:inherit;margin:0;padding:0}/*!@button,\nselect*/button.sc-ft-container,select.sc-ft-container{text-transform:none}/*!@button,\n[type='button'],\n[type='reset'],\n[type='submit']*/button.sc-ft-container,[type='button'].sc-ft-container,[type='reset'].sc-ft-container,[type='submit'].sc-ft-container{-webkit-appearance:button;background-color:transparent;background-image:none}/*!@:-moz-focusring*/.sc-ft-container:-moz-focusring{outline:auto}/*!@:-moz-ui-invalid*/.sc-ft-container:-moz-ui-invalid{box-shadow:none}/*!@progress*/progress.sc-ft-container{vertical-align:baseline}/*!@::-webkit-inner-spin-button,\n::-webkit-outer-spin-button*/.sc-ft-container::-webkit-inner-spin-button,.sc-ft-container::-webkit-outer-spin-button{height:auto}/*!@[type='search']*/[type='search'].sc-ft-container{-webkit-appearance:textfield;outline-offset:-2px}/*!@::-webkit-search-decoration*/.sc-ft-container::-webkit-search-decoration{-webkit-appearance:none}/*!@::-webkit-file-upload-button*/.sc-ft-container::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}/*!@summary*/summary.sc-ft-container{display:list-item}/*!@blockquote,\ndl,\ndd,\nh1,\nh2,\nh3,\nh4,\nh5,\nh6,\nhr,\nfigure,\np,\npre*/blockquote.sc-ft-container,dl.sc-ft-container,dd.sc-ft-container,h1.sc-ft-container,h2.sc-ft-container,h3.sc-ft-container,h4.sc-ft-container,h5.sc-ft-container,h6.sc-ft-container,hr.sc-ft-container,figure.sc-ft-container,p.sc-ft-container,pre.sc-ft-container{margin:0}/*!@fieldset*/fieldset.sc-ft-container{margin:0;padding:0}/*!@legend*/legend.sc-ft-container{padding:0}/*!@ol,\nul,\nmenu*/ol.sc-ft-container,ul.sc-ft-container,menu.sc-ft-container{list-style:none;margin:0;padding:0}/*!@dialog*/dialog.sc-ft-container{padding:0}/*!@textarea*/textarea.sc-ft-container{resize:vertical}/*!@input::-moz-placeholder, textarea::-moz-placeholder*/input.sc-ft-container::-moz-placeholder,textarea.sc-ft-container::-moz-placeholder{opacity:1;color:#9ca3af}/*!@input::placeholder,\ntextarea::placeholder*/input.sc-ft-container::placeholder,textarea.sc-ft-container::placeholder{opacity:1;color:#9ca3af}/*!@button,\n[role=\"button\"]*/button.sc-ft-container,[role=\"button\"].sc-ft-container{cursor:pointer}/*!@:disabled*/.sc-ft-container:disabled{cursor:default}/*!@img,\nsvg,\nvideo,\ncanvas,\naudio,\niframe,\nembed,\nobject*/img.sc-ft-container,svg.sc-ft-container,video.sc-ft-container,canvas.sc-ft-container,audio.sc-ft-container,iframe.sc-ft-container,embed.sc-ft-container,object.sc-ft-container{display:block;vertical-align:middle}/*!@img,\nvideo*/img.sc-ft-container,video.sc-ft-container{max-width:100%;height:auto}/*!@[hidden]*/[hidden].sc-ft-container{display:none}/*!@*, ::before, ::after*/*.sc-ft-container,.sc-ft-container::before,.sc-ft-container::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}/*!@::backdrop*/.sc-ft-container::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}/*!@.mb-8*/.mb-8.sc-ft-container{margin-bottom:2rem}/*!@.inline-block*/.inline-block.sc-ft-container{display:inline-block}/*!@.flex*/.flex.sc-ft-container{display:flex}/*!@.hidden*/.hidden.sc-ft-container{display:none}/*!@.h-0*/.h-0.sc-ft-container{height:0px}/*!@.min-h-\\[100vh\\]*/.min-h-\\[100vh\\].sc-ft-container{min-height:100vh}/*!@.w-0*/.w-0.sc-ft-container{width:0px}/*!@.items-center*/.items-center.sc-ft-container{align-items:center}/*!@.bg-gray-100*/.bg-gray-100.sc-ft-container{--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity))}/*!@.bg-red-500*/.bg-red-500.sc-ft-container{--tw-bg-opacity:1;background-color:rgb(239 68 68 / var(--tw-bg-opacity))}/*!@.p-4*/.p-4.sc-ft-container{padding:1rem}/*!@.shadow*/.shadow.sc-ft-container{--tw-shadow:0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 1px 3px 0 var(--tw-shadow-color), 0 1px 2px -1px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}/*!@.transition*/.transition.sc-ft-container{transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, -webkit-backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter, -webkit-backdrop-filter;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}/*!@.ease-in-out*/.ease-in-out.sc-ft-container{transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}/*!@:host*/.sc-ft-container-h{display:block}@media (prefers-color-scheme: dark){/*!@.dark\\:bg-gray-700*/.dark\\:bg-gray-700.sc-ft-container{--tw-bg-opacity:1;background-color:rgb(55 65 81 / var(--tw-bg-opacity))}/*!@.dark\\:text-white*/.dark\\:text-white.sc-ft-container{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity))}}";
...
class FtContainer {
  ...
  render() {
    return (hAsync(Host, null, hAsync("div", { class: "p-4" }, hAsync("slot", null))));
  }
  static get style() { return ftContainerCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "ft-container",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const ftPageCss = "/*!@*,\n::before,\n::after*/*.sc-ft-page,.sc-ft-page::before,.sc-ft-page::after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}/*!@::before,\n::after*/.sc-ft-page::before,.sc-ft-page::after{--tw-content:''}/*!@html*/html.sc-ft-page{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;-o-tab-size:4;tab-size:4;font-family:ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";font-feature-settings:normal;font-variation-settings:normal}/*!@body*/body.sc-ft-page{margin:0;line-height:inherit}/*!@hr*/hr.sc-ft-page{height:0;color:inherit;border-top-width:1px}/*!@abbr:where([title])*/abbr.sc-ft-page:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}/*!@h1,\nh2,\nh3,\nh4,\nh5,\nh6*/h1.sc-ft-page,h2.sc-ft-page,h3.sc-ft-page,h4.sc-ft-page,h5.sc-ft-page,h6.sc-ft-page{font-size:inherit;font-weight:inherit}/*!@a*/a.sc-ft-page{color:inherit;text-decoration:inherit}/*!@b,\nstrong*/b.sc-ft-page,strong.sc-ft-page{font-weight:bolder}/*!@code,\nkbd,\nsamp,\npre*/code.sc-ft-page,kbd.sc-ft-page,samp.sc-ft-page,pre.sc-ft-page{font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace;font-size:1em}/*!@small*/small.sc-ft-page{font-size:80%}/*!@sub,\nsup*/sub.sc-ft-page,sup.sc-ft-page{font-size:75%;line-height:0;position:relative;vertical-align:baseline}/*!@sub*/sub.sc-ft-page{bottom:-0.25em}/*!@sup*/sup.sc-ft-page{top:-0.5em}/*!@table*/table.sc-ft-page{text-indent:0;border-color:inherit;border-collapse:collapse}/*!@button,\ninput,\noptgroup,\nselect,\ntextarea*/button.sc-ft-page,input.sc-ft-page,optgroup.sc-ft-page,select.sc-ft-page,textarea.sc-ft-page{font-family:inherit;font-feature-settings:inherit;font-variation-settings:inherit;font-size:100%;font-weight:inherit;line-height:inherit;color:inherit;margin:0;padding:0}/*!@button,\nselect*/button.sc-ft-page,select.sc-ft-page{text-transform:none}/*!@button,\n[type='button'],\n[type='reset'],\n[type='submit']*/button.sc-ft-page,[type='button'].sc-ft-page,[type='reset'].sc-ft-page,[type='submit'].sc-ft-page{-webkit-appearance:button;background-color:transparent;background-image:none}/*!@:-moz-focusring*/.sc-ft-page:-moz-focusring{outline:auto}/*!@:-moz-ui-invalid*/.sc-ft-page:-moz-ui-invalid{box-shadow:none}/*!@progress*/progress.sc-ft-page{vertical-align:baseline}/*!@::-webkit-inner-spin-button,\n::-webkit-outer-spin-button*/.sc-ft-page::-webkit-inner-spin-button,.sc-ft-page::-webkit-outer-spin-button{height:auto}/*!@[type='search']*/[type='search'].sc-ft-page{-webkit-appearance:textfield;outline-offset:-2px}/*!@::-webkit-search-decoration*/.sc-ft-page::-webkit-search-decoration{-webkit-appearance:none}/*!@::-webkit-file-upload-button*/.sc-ft-page::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}/*!@summary*/summary.sc-ft-page{display:list-item}/*!@blockquote,\ndl,\ndd,\nh1,\nh2,\nh3,\nh4,\nh5,\nh6,\nhr,\nfigure,\np,\npre*/blockquote.sc-ft-page,dl.sc-ft-page,dd.sc-ft-page,h1.sc-ft-page,h2.sc-ft-page,h3.sc-ft-page,h4.sc-ft-page,h5.sc-ft-page,h6.sc-ft-page,hr.sc-ft-page,figure.sc-ft-page,p.sc-ft-page,pre.sc-ft-page{margin:0}/*!@fieldset*/fieldset.sc-ft-page{margin:0;padding:0}/*!@legend*/legend.sc-ft-page{padding:0}/*!@ol,\nul,\nmenu*/ol.sc-ft-page,ul.sc-ft-page,menu.sc-ft-page{list-style:none;margin:0;padding:0}/*!@dialog*/dialog.sc-ft-page{padding:0}/*!@textarea*/textarea.sc-ft-page{resize:vertical}/*!@input::-moz-placeholder, textarea::-moz-placeholder*/input.sc-ft-page::-moz-placeholder,textarea.sc-ft-page::-moz-placeholder{opacity:1;color:#9ca3af}/*!@input::placeholder,\ntextarea::placeholder*/input.sc-ft-page::placeholder,textarea.sc-ft-page::placeholder{opacity:1;color:#9ca3af}/*!@button,\n[role=\"button\"]*/button.sc-ft-page,[role=\"button\"].sc-ft-page{cursor:pointer}/*!@:disabled*/.sc-ft-page:disabled{cursor:default}/*!@img,\nsvg,\nvideo,\ncanvas,\naudio,\niframe,\nembed,\nobject*/img.sc-ft-page,svg.sc-ft-page,video.sc-ft-page,canvas.sc-ft-page,audio.sc-ft-page,iframe.sc-ft-page,embed.sc-ft-page,object.sc-ft-page{display:block;vertical-align:middle}/*!@img,\nvideo*/img.sc-ft-page,video.sc-ft-page{max-width:100%;height:auto}/*!@[hidden]*/[hidden].sc-ft-page{display:none}/*!@*, ::before, ::after*/*.sc-ft-page,.sc-ft-page::before,.sc-ft-page::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}/*!@::backdrop*/.sc-ft-page::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}/*!@.mb-8*/.mb-8.sc-ft-page{margin-bottom:2rem}/*!@.inline-block*/.inline-block.sc-ft-page{display:inline-block}/*!@.flex*/.flex.sc-ft-page{display:flex}/*!@.hidden*/.hidden.sc-ft-page{display:none}/*!@.h-0*/.h-0.sc-ft-page{height:0px}/*!@.min-h-\\[100vh\\]*/.min-h-\\[100vh\\].sc-ft-page{min-height:100vh}/*!@.w-0*/.w-0.sc-ft-page{width:0px}/*!@.items-center*/.items-center.sc-ft-page{align-items:center}/*!@.bg-gray-100*/.bg-gray-100.sc-ft-page{--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity))}/*!@.bg-red-500*/.bg-red-500.sc-ft-page{--tw-bg-opacity:1;background-color:rgb(239 68 68 / var(--tw-bg-opacity))}/*!@.p-4*/.p-4.sc-ft-page{padding:1rem}/*!@.shadow*/.shadow.sc-ft-page{--tw-shadow:0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 1px 3px 0 var(--tw-shadow-color), 0 1px 2px -1px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}/*!@.transition*/.transition.sc-ft-page{transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, -webkit-backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter, -webkit-backdrop-filter;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}/*!@.ease-in-out*/.ease-in-out.sc-ft-page{transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}/*!@:host*/.sc-ft-page-h{display:block}@media (prefers-color-scheme: dark){/*!@.dark\\:bg-gray-700*/.dark\\:bg-gray-700.sc-ft-page{--tw-bg-opacity:1;background-color:rgb(55 65 81 / var(--tw-bg-opacity))}/*!@.dark\\:text-white*/.dark\\:text-white.sc-ft-page{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity))}}";
...
class FtPage {
  ...
  render() {
    return (hAsync(Host, null, hAsync("div", { class: "bg-gray-100 dark:bg-gray-700 dark:text-white min-h-[100vh]" }, hAsync("slot", null))));
  }
  static get style() { return ftPageCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "ft-page",
    "$members$": undefined,
...
const ftToggleCss = "/*!@*,\n::before,\n::after*/*.sc-ft-toggle,.sc-ft-toggle::before,.sc-ft-toggle::after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}/*!@::before,\n::after*/.sc-ft-toggle::before,.sc-ft-toggle::after{--tw-content:''}/*!@html*/html.sc-ft-toggle{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;-o-tab-size:4;tab-size:4;font-family:ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";font-feature-settings:normal;font-variation-settings:normal}/*!@body*/body.sc-ft-toggle{margin:0;line-height:inherit}/*!@hr*/hr.sc-ft-toggle{height:0;color:inherit;border-top-width:1px}/*!@abbr:where([title])*/abbr.sc-ft-toggle:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}/*!@h1,\nh2,\nh3,\nh4,\nh5,\nh6*/h1.sc-ft-toggle,h2.sc-ft-toggle,h3.sc-ft-toggle,h4.sc-ft-toggle,h5.sc-ft-toggle,h6.sc-ft-toggle{font-size:inherit;font-weight:inherit}/*!@a*/a.sc-ft-toggle{color:inherit;text-decoration:inherit}/*!@b,\nstrong*/b.sc-ft-toggle,strong.sc-ft-toggle{font-weight:bolder}/*!@code,\nkbd,\nsamp,\npre*/code.sc-ft-toggle,kbd.sc-ft-toggle,samp.sc-ft-toggle,pre.sc-ft-toggle{font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace;font-size:1em}/*!@small*/small.sc-ft-toggle{font-size:80%}/*!@sub,\nsup*/sub.sc-ft-toggle,sup.sc-ft-toggle{font-size:75%;line-height:0;position:relative;vertical-align:baseline}/*!@sub*/sub.sc-ft-toggle{bottom:-0.25em}/*!@sup*/sup.sc-ft-toggle{top:-0.5em}/*!@table*/table.sc-ft-toggle{text-indent:0;border-color:inherit;border-collapse:collapse}/*!@button,\ninput,\noptgroup,\nselect,\ntextarea*/button.sc-ft-toggle,input.sc-ft-toggle,optgroup.sc-ft-toggle,select.sc-ft-toggle,textarea.sc-ft-toggle{font-family:inherit;font-feature-settings:inherit;font-variation-settings:inherit;font-size:100%;font-weight:inherit;line-height:inherit;color:inherit;margin:0;padding:0}/*!@button,\nselect*/button.sc-ft-toggle,select.sc-ft-toggle{text-transform:none}/*!@button,\n[type='button'],\n[type='reset'],\n[type='submit']*/button.sc-ft-toggle,[type='button'].sc-ft-toggle,[type='reset'].sc-ft-toggle,[type='submit'].sc-ft-toggle{-webkit-appearance:button;background-color:transparent;background-image:none}/*!@:-moz-focusring*/.sc-ft-toggle:-moz-focusring{outline:auto}/*!@:-moz-ui-invalid*/.sc-ft-toggle:-moz-ui-invalid{box-shadow:none}/*!@progress*/progress.sc-ft-toggle{vertical-align:baseline}/*!@::-webkit-inner-spin-button,\n::-webkit-outer-spin-button*/.sc-ft-toggle::-webkit-inner-spin-button,.sc-ft-toggle::-webkit-outer-spin-button{height:auto}/*!@[type='search']*/[type='search'].sc-ft-toggle{-webkit-appearance:textfield;outline-offset:-2px}/*!@::-webkit-search-decoration*/.sc-ft-toggle::-webkit-search-decoration{-webkit-appearance:none}/*!@::-webkit-file-upload-button*/.sc-ft-toggle::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}/*!@summary*/summary.sc-ft-toggle{display:list-item}/*!@blockquote,\ndl,\ndd,\nh1,\nh2,\nh3,\nh4,\nh5,\nh6,\nhr,\nfigure,\np,\npre*/blockquote.sc-ft-toggle,dl.sc-ft-toggle,dd.sc-ft-toggle,h1.sc-ft-toggle,h2.sc-ft-toggle,h3.sc-ft-toggle,h4.sc-ft-toggle,h5.sc-ft-toggle,h6.sc-ft-toggle,hr.sc-ft-toggle,figure.sc-ft-toggle,p.sc-ft-toggle,pre.sc-ft-toggle{margin:0}/*!@fieldset*/fieldset.sc-ft-toggle{margin:0;padding:0}/*!@legend*/legend.sc-ft-toggle{padding:0}/*!@ol,\nul,\nmenu*/ol.sc-ft-toggle,ul.sc-ft-toggle,menu.sc-ft-toggle{list-style:none;margin:0;padding:0}/*!@dialog*/dialog.sc-ft-toggle{padding:0}/*!@textarea*/textarea.sc-ft-toggle{resize:vertical}/*!@input::-moz-placeholder, textarea::-moz-placeholder*/input.sc-ft-toggle::-moz-placeholder,textarea.sc-ft-toggle::-moz-placeholder{opacity:1;color:#9ca3af}/*!@input::placeholder,\ntextarea::placeholder*/input.sc-ft-toggle::placeholder,textarea.sc-ft-toggle::placeholder{opacity:1;color:#9ca3af}/*!@button,\n[role=\"button\"]*/button.sc-ft-toggle,[role=\"button\"].sc-ft-toggle{cursor:pointer}/*!@:disabled*/.sc-ft-toggle:disabled{cursor:default}/*!@img,\nsvg,\nvideo,\ncanvas,\naudio,\niframe,\nembed,\nobject*/img.sc-ft-toggle,svg.sc-ft-toggle,video.sc-ft-toggle,canvas.sc-ft-toggle,audio.sc-ft-toggle,iframe.sc-ft-toggle,embed.sc-ft-toggle,object.sc-ft-toggle{display:block;vertical-align:middle}/*!@img,\nvideo*/img.sc-ft-toggle,video.sc-ft-toggle{max-width:100%;height:auto}/*!@[hidden]*/[hidden].sc-ft-toggle{display:none}/*!@*, ::before, ::after*/*.sc-ft-toggle,.sc-ft-toggle::before,.sc-ft-toggle::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}/*!@::backdrop*/.sc-ft-toggle::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}/*!@.mb-8*/.mb-8.sc-ft-toggle{margin-bottom:2rem}/*!@.inline-block*/.inline-block.sc-ft-toggle{display:inline-block}/*!@.flex*/.flex.sc-ft-toggle{display:flex}/*!@.hidden*/.hidden.sc-ft-toggle{display:none}/*!@.h-0*/.h-0.sc-ft-toggle{height:0px}/*!@.min-h-\\[100vh\\]*/.min-h-\\[100vh\\].sc-ft-toggle{min-height:100vh}/*!@.w-0*/.w-0.sc-ft-toggle{width:0px}/*!@.items-center*/.items-center.sc-ft-toggle{align-items:center}/*!@.bg-gray-100*/.bg-gray-100.sc-ft-toggle{--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity))}/*!@.bg-red-500*/.bg-red-500.sc-ft-toggle{--tw-bg-opacity:1;background-color:rgb(239 68 68 / var(--tw-bg-opacity))}/*!@.p-4*/.p-4.sc-ft-toggle{padding:1rem}/*!@.shadow*/.shadow.sc-ft-toggle{--tw-shadow:0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 1px 3px 0 var(--tw-shadow-color), 0 1px 2px -1px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}/*!@.transition*/.transition.sc-ft-toggle{transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, -webkit-backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter, -webkit-backdrop-filter;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}/*!@.ease-in-out*/.ease-in-out.sc-ft-toggle{transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}/*!@:host*/.sc-ft-toggle-h{display:inline-block}/*!@.toggle-wrapper*/.toggle-wrapper.sc-ft-toggle{position:relative;margin-left:0.5rem;margin-right:0.5rem;display:block;width:64px;cursor:pointer;border-radius:9999px;--tw-bg-opacity:1;background-color:rgb(209 213 219 / var(--tw-bg-opacity));padding:0.25rem}@media (prefers-color-scheme: dark){/*!@.toggle-wrapper*/.toggle-wrapper.sc-ft-toggle{--tw-bg-opacity:1;background-color:rgb(107 114 128 / var(--tw-bg-opacity))}}/*!@.toggle-item*/.toggle-item.sc-ft-toggle{height:24px;width:24px;overflow:hidden;border-radius:9999px;--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity));padding:0.25rem;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, -webkit-backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter, -webkit-backdrop-filter;transition-duration:150ms;transition-delay:100ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}/*!@.input*/.input.sc-ft-toggle{display:none}/*!@.toggle-item.active*/.toggle-item.active.sc-ft-toggle{--tw-translate-x:130%;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}/*!@.toggle-wrapper.active*/.toggle-wrapper.active.sc-ft-toggle{--tw-bg-opacity:1;background-color:rgb(34 197 94 / var(--tw-bg-opacity))}/*!@.toggle-svg*/.toggle-svg.sc-ft-toggle{fill:#000}@media (prefers-color-scheme: dark){/*!@.dark\\:bg-gray-700*/.dark\\:bg-gray-700.sc-ft-toggle{--tw-bg-opacity:1;background-color:rgb(55 65 81 / var(--tw-bg-opacity))}/*!@.dark\\:text-white*/.dark\\:text-white.sc-ft-toggle{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity))}}";
...
class FtToggle {
  ...
  toggle() {
    ...
    if (this.debug)
      console.log('toggle', this.customValue);
  ...
  render() {
    return (hAsync("label", { htmlFor: this.customId, class: "flex items-center" }, hAsync("span", null, this.label), hAsync("div", { class: `toggle-wrapper ${this.checked ? 'active' : ''}` }, hAsync("input", { id: this.customId, type: "checkbox", class: "input", onClick: this.toggle.bind(this) }), hAsync("div", { class: this.toggleClasses() }, hAsync("span", null, hAsync("svg", { class: `transition ease-in-out delay-400 ${!this.checked ? 'w-0 h-0 hidden' : ''}`, xmlns: "http://www.w3.org/4000/svg", viewBox: "0 0 50 50" }, hAsync("path", { class: "toggle-svg", d: "M40.267 14.628 20.974 33.921l-9.293-9.293a.999.999 0 1 0-1.414 1.414l10 10a.997.997 0 0 0 1.414 0l20-20a.999.999 0 1 0-1.414-1.414z" })), hAsync("svg", { class: `transition ease-in-out delay-400 ${this.checked ? 'w-0 h-0 hidden' : ''}`, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 50 50" }, hAsync("path", { class: "toggle-svg", d: "M9.016 40.837a1.001 1.001 0 0 0 1.415-.001l14.292-14.309 14.292 14.309a1 1 0 0 0 1.416-1.413L26.153 25.129 40.43 10.836a1 1 0 1 0-1.415-1.413L24.722 23.732 10.43 9.423a1 1 0 1 0-1.415 1.413l14.276 14.293L9.015 39.423a1 1 0 0 0 .001 1.414z" })))))));
  }
  get el() { return getElement(this); }
  static get style() { return ftToggleCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "ft-toggle",
    "$members$": {
      "customId": [1, "custom-id"],
      "values": [16],
      "customValue": [1032, "custom-value"],
      "label": [1],
      "debug": [4],
      "checked": [32]
    },
...
const ftToolbarCss = "/*!@*,\n::before,\n::after*/*.sc-ft-toolbar,.sc-ft-toolbar::before,.sc-ft-toolbar::after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}/*!@::before,\n::after*/.sc-ft-toolbar::before,.sc-ft-toolbar::after{--tw-content:''}/*!@html*/html.sc-ft-toolbar{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;-o-tab-size:4;tab-size:4;font-family:ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";font-feature-settings:normal;font-variation-settings:normal}/*!@body*/body.sc-ft-toolbar{margin:0;line-height:inherit}/*!@hr*/hr.sc-ft-toolbar{height:0;color:inherit;border-top-width:1px}/*!@abbr:where([title])*/abbr.sc-ft-toolbar:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}/*!@h1,\nh2,\nh3,\nh4,\nh5,\nh6*/h1.sc-ft-toolbar,h2.sc-ft-toolbar,h3.sc-ft-toolbar,h4.sc-ft-toolbar,h5.sc-ft-toolbar,h6.sc-ft-toolbar{font-size:inherit;font-weight:inherit}/*!@a*/a.sc-ft-toolbar{color:inherit;text-decoration:inherit}/*!@b,\nstrong*/b.sc-ft-toolbar,strong.sc-ft-toolbar{font-weight:bolder}/*!@code,\nkbd,\nsamp,\npre*/code.sc-ft-toolbar,kbd.sc-ft-toolbar,samp.sc-ft-toolbar,pre.sc-ft-toolbar{font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace;font-size:1em}/*!@small*/small.sc-ft-toolbar{font-size:80%}/*!@sub,\nsup*/sub.sc-ft-toolbar,sup.sc-ft-toolbar{font-size:75%;line-height:0;position:relative;vertical-align:baseline}/*!@sub*/sub.sc-ft-toolbar{bottom:-0.25em}/*!@sup*/sup.sc-ft-toolbar{top:-0.5em}/*!@table*/table.sc-ft-toolbar{text-indent:0;border-color:inherit;border-collapse:collapse}/*!@button,\ninput,\noptgroup,\nselect,\ntextarea*/button.sc-ft-toolbar,input.sc-ft-toolbar,optgroup.sc-ft-toolbar,select.sc-ft-toolbar,textarea.sc-ft-toolbar{font-family:inherit;font-feature-settings:inherit;font-variation-settings:inherit;font-size:100%;font-weight:inherit;line-height:inherit;color:inherit;margin:0;padding:0}/*!@button,\nselect*/button.sc-ft-toolbar,select.sc-ft-toolbar{text-transform:none}/*!@button,\n[type='button'],\n[type='reset'],\n[type='submit']*/button.sc-ft-toolbar,[type='button'].sc-ft-toolbar,[type='reset'].sc-ft-toolbar,[type='submit'].sc-ft-toolbar{-webkit-appearance:button;background-color:transparent;background-image:none}/*!@:-moz-focusring*/.sc-ft-toolbar:-moz-focusring{outline:auto}/*!@:-moz-ui-invalid*/.sc-ft-toolbar:-moz-ui-invalid{box-shadow:none}/*!@progress*/progress.sc-ft-toolbar{vertical-align:baseline}/*!@::-webkit-inner-spin-button,\n::-webkit-outer-spin-button*/.sc-ft-toolbar::-webkit-inner-spin-button,.sc-ft-toolbar::-webkit-outer-spin-button{height:auto}/*!@[type='search']*/[type='search'].sc-ft-toolbar{-webkit-appearance:textfield;outline-offset:-2px}/*!@::-webkit-search-decoration*/.sc-ft-toolbar::-webkit-search-decoration{-webkit-appearance:none}/*!@::-webkit-file-upload-button*/.sc-ft-toolbar::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}/*!@summary*/summary.sc-ft-toolbar{display:list-item}/*!@blockquote,\ndl,\ndd,\nh1,\nh2,\nh3,\nh4,\nh5,\nh6,\nhr,\nfigure,\np,\npre*/blockquote.sc-ft-toolbar,dl.sc-ft-toolbar,dd.sc-ft-toolbar,h1.sc-ft-toolbar,h2.sc-ft-toolbar,h3.sc-ft-toolbar,h4.sc-ft-toolbar,h5.sc-ft-toolbar,h6.sc-ft-toolbar,hr.sc-ft-toolbar,figure.sc-ft-toolbar,p.sc-ft-toolbar,pre.sc-ft-toolbar{margin:0}/*!@fieldset*/fieldset.sc-ft-toolbar{margin:0;padding:0}/*!@legend*/legend.sc-ft-toolbar{padding:0}/*!@ol,\nul,\nmenu*/ol.sc-ft-toolbar,ul.sc-ft-toolbar,menu.sc-ft-toolbar{list-style:none;margin:0;padding:0}/*!@dialog*/dialog.sc-ft-toolbar{padding:0}/*!@textarea*/textarea.sc-ft-toolbar{resize:vertical}/*!@input::-moz-placeholder, textarea::-moz-placeholder*/input.sc-ft-toolbar::-moz-placeholder,textarea.sc-ft-toolbar::-moz-placeholder{opacity:1;color:#9ca3af}/*!@input::placeholder,\ntextarea::placeholder*/input.sc-ft-toolbar::placeholder,textarea.sc-ft-toolbar::placeholder{opacity:1;color:#9ca3af}/*!@button,\n[role=\"button\"]*/button.sc-ft-toolbar,[role=\"button\"].sc-ft-toolbar{cursor:pointer}/*!@:disabled*/.sc-ft-toolbar:disabled{cursor:default}/*!@img,\nsvg,\nvideo,\ncanvas,\naudio,\niframe,\nembed,\nobject*/img.sc-ft-toolbar,svg.sc-ft-toolbar,video.sc-ft-toolbar,canvas.sc-ft-toolbar,audio.sc-ft-toolbar,iframe.sc-ft-toolbar,embed.sc-ft-toolbar,object.sc-ft-toolbar{display:block;vertical-align:middle}/*!@img,\nvideo*/img.sc-ft-toolbar,video.sc-ft-toolbar{max-width:100%;height:auto}/*!@[hidden]*/[hidden].sc-ft-toolbar{display:none}/*!@*, ::before, ::after*/*.sc-ft-toolbar,.sc-ft-toolbar::before,.sc-ft-toolbar::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}/*!@::backdrop*/.sc-ft-toolbar::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}/*!@.mb-8*/.mb-8.sc-ft-toolbar{margin-bottom:2rem}/*!@.inline-block*/.inline-block.sc-ft-toolbar{display:inline-block}/*!@.flex*/.flex.sc-ft-toolbar{display:flex}/*!@.hidden*/.hidden.sc-ft-toolbar{display:none}/*!@.h-0*/.h-0.sc-ft-toolbar{height:0px}/*!@.min-h-\\[100vh\\]*/.min-h-\\[100vh\\].sc-ft-toolbar{min-height:100vh}/*!@.w-0*/.w-0.sc-ft-toolbar{width:0px}/*!@.items-center*/.items-center.sc-ft-toolbar{align-items:center}/*!@.bg-gray-100*/.bg-gray-100.sc-ft-toolbar{--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity))}/*!@.bg-red-500*/.bg-red-500.sc-ft-toolbar{--tw-bg-opacity:1;background-color:rgb(239 68 68 / var(--tw-bg-opacity))}/*!@.p-4*/.p-4.sc-ft-toolbar{padding:1rem}/*!@.shadow*/.shadow.sc-ft-toolbar{--tw-shadow:0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 1px 3px 0 var(--tw-shadow-color), 0 1px 2px -1px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}/*!@.transition*/.transition.sc-ft-toolbar{transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, -webkit-backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter, -webkit-backdrop-filter;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}/*!@.ease-in-out*/.ease-in-out.sc-ft-toolbar{transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}/*!@:host*/.sc-ft-toolbar-h{display:block}/*!@h1*/h1.sc-ft-toolbar{font-size:2.25rem;line-height:2.5rem}@media (prefers-color-scheme: dark){/*!@.dark\\:bg-gray-700*/.dark\\:bg-gray-700.sc-ft-toolbar{--tw-bg-opacity:1;background-color:rgb(55 65 81 / var(--tw-bg-opacity))}/*!@.dark\\:text-white*/.dark\\:text-white.sc-ft-toolbar{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity))}}";
...
class FtToolbar {
  ...
  render() {
    return (hAsync(Host, null, hAsync("header", { class: "mb-8 bg-red-500 p-4" }, this.text ? hAsync("h1", null, this.text) : null, hAsync("slot", null))));
  }
  static get style() { return ftToolbarCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "ft-toolbar",
    "$members$": {
