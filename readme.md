...
- Put a script tag similar to this `<script type='module' src='https://unpkg.com/my-component@0.0.1/dist/future-ui.esm.js'></script>` in the head of your index.html
- Then you can use the element anywhere in your template, JSX, html etc

### Node Modules
- Run `npm install future-ui --save`
...
- Run `npm install future-ui --save`
- Add an import to the npm packages `import future-ui;`
- Then you can use the element anywhere in your template, JSX, html etc
